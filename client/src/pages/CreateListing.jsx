        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className='flex gap-4'>
                    <input className='P-3 border-gray-300 rounded-lg w-full' type="file" id='images' accept='image/*' multiple />
                ...
                <button className='p-3 bg-slate-700 text-white rounded-lg upppercase
